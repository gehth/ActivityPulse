...
from PyQt5.QtCore import Qt, QPropertyAnimation, QEasingCurve, QTimer, QEvent
from PyQt5.QtGui import QColor, QPainter, QBrush, QRadialGradient, QPaintEvent, QHideEvent, QShowEvent, QMouseEvent, QResizeEvent
...
from gui.qss_styles import QSS_STYLES  # noqa: F401 - re-export for backward compatibility
